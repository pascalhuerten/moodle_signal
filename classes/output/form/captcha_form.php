...
/**
 * Form to create a signal account.
 *
...
/**
 * Form to enter captcha during signal account creation.
 *
 * @package   message_signal
 * @copyright 2022, Pascal Hürten <pascal.huerten@th-luebeck.de>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class captcha_form extends \moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('text',  'captcha',  get_string('captcha', 'message_signal'));
        $mform->setType('captcha', PARAM_NOTAGS);
    ...
    public function action() {
        ...
        return $manager->create_account($data->botaccount, $data->captcha);
    }
}
