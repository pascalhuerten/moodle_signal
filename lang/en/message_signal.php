...
$string['botaboutdesc'] = 'Status message, that is displayed in the signal accounts profile.';
...
$string['signalapiurldesc'] = 'This address will be used to make request to the Signal API.';
